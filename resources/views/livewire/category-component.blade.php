							...
							<li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
								<div class="product product-style-3 equal-elem ">
									...
									<div class="product-info">
										...
										{{-- <form action="/cart">
											<input type="hidden" name="wahyu" value="({{ $product->id}},'{{ $product->name }}',{{ $product->regular_price }})">
											<button type="submit">Add To Chart</button>
										</form> --}}

										{{-- <button wire:click.prevent="({{ $product->id}},'{{ $product->name }}',{{ $product->regular_price }})" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
											Add To Cart
										</button> --}}

										{{-- <button type="button" wire:$toggle="({{ $product->id}},'{{ $product->name }}',{{ $product->regular_price }})" class="btn btn-success">Add New Category</button> --}}

										{{-- <a href="#" wire:click.prevent="$toggle('({{ $product->id}},'{{ $product->name }}',{{ $product->regular_price }})')" class="btn btn-success">Add New Category</a> --}}
